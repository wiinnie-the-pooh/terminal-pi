...
|   +-- piResolver.ts              # cross-platform node.exe resolution (Windows: sibling/where.exe lookup)
...
|   +-- terminalManager.test.js         # PiTerminalManager.runInteractive / runWithPrompt tests
